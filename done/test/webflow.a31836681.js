        ...
        window.tram = function(e) {
            ...
            function c(l, h, I) {
                ...
                l === void 0)
                    return I;
                var O = I;
                return Mi.test(l) || !rn.test(l) ? O = parseInt(l, 10) : rn.test(l) && (O = 1e3 * parseFloat(l)),
                0 > O && (O = 0),
                O === O ? O : I
            }
            function f(l) {
            ...
            var d = function(l, h, I) {
                ...
                function W(Q, fe) {
                    function U() {
                        var Ne = new ne;
                        return y(Ne.init) && Ne.init.apply(Ne, arguments),
                        Ne
                    }
                    function ne() {}
                    fe === I && (fe = Q,
                    Q = Object),
                    U.Bare = ne;
                    var ie, ye = S[l] = Q[l], Je = ne[l] = U[l] = new S;
                    return Je.constructor = U,
                    U.mixin = function(Ne) {
                        return ne[l] = U[l] = W(U, Ne)[l],
                        U
                    }
                    ,
                    U.open = function(Ne) {
                        ...
                        O(ie))
                            for (var Ir in ie)
                                h.call(ie, Ir) && (Je[Ir] = ie[Ir]);
                        return y(Je.init) || (Je.init = Q),
                        U
                    }
                    ,
                    U.open(fe)
              ...
              , v = {
                ...
                "ease-in-out-back": ["cubic-bezier(0.680, -0.550, 0.265, 1.550)", function(l, h, I, O, y) {
                    return y === void 0 && (y = 1.70158),
                    (l /= O / 2) < 1 ? I / 2 * l * l * (((y *= 1.525) + 1) * l - y) + h : I / 2 * ((l -= 2) * l * (((y *= 1.525) + 1) * l + y) + 2) + h
                }
                ]
            }
              , E = {
            ...
            var L = t.frame = function() {
              ...
              , B = d(function(l) {
                function h(k, se) {
                    ...
                    if (!se.weak || !this.props[ue]) {
                        var Be = Pe[0]
                          , Me = this.props[ue];
                        return Me || (Me = this.props[ue] = new Be.Bare),
                ...
                function Je(k, se, Ee) {
                    var ue, Pe, Be, Me, nn = se !== Ne, Ie = {};
                    for (ue in k)
                        Be = k[ue],
                        ue in Ze ? (Ie.transform || (Ie.transform = {}),
                        Ie.transform[ue] = Be) : (R.test(ue) && (ue = r(ue)),
                        ue in yr ? Ie[ue] = Be : (Me || (Me = {}),
                        Me[ue] = Be));
                    for (ue in Ie) {
                        if (Be = Ie[ue],
                        Pe = this.props[ue],
                ...
                function Ve(k, se) {
                    l[k] = function() {
                        return this.children ? dI.call(this, se, arguments) : (this.el && se.apply(this, arguments),
                        this)
                    }
                }
                function dI(k, se) {
              ...
              , F = d(function(l) {
                ...
                l.init = function(S, W, Q, fe) {
                    ...
                    _e.fallback || fe.fallback ? this.animate = this.fallback : (this.animate = this.transition,
                ...
                l.convert = function(S, W) {
                    if (S == "auto" && this.auto)
                        return S;
                    var Q, fe = typeof S == "number", U = typeof S == "string";
                    switch (W) {
                    case m:
                        if (fe)
                            return S;
              ...
              , oe = d(F, function(l, h) {
                ...
                l.init = function() {
                    ...
                    Ze.perspective && _e.perspective && (this.current.perspective = _e.perspective,
              ...
              , z = d(function(l) {
                ...
                l.render = function(U) {
                    ...
                    if (ie < this.duration) {
                        ...
                        return ne = this.startRGB ? S(this.startRGB, this.endRGB, ye) : y(this.begin + ye * this.change),
              ...
              , Xt = d(z, function(l, h) {
                l.init = function(I) {
                    ...
                    for (O in I.values)
                        y = I.values[O],
                        this.current[O] !== y && this.tweens.push(new z({
                            name: O,
                            from: this.current[O],
                            to: y,
                            duration: I.duration,
                ...
                ,
                l.render = function(I) {
                    var O, y, S = this.tweens.length, W = !1;
                    for (O = S; O--; )
                        y = this.tweens[O],
                        y.context && (y.render(I),
                        this.current[y.name] = y.value,
                        W = !0);
            ...
            G.transform && G.backface && (Ze.z = [C, "translateZ"],
            Ze.rotateZ = [D],
            Ze.scaleZ = [m],
            Ze.perspective = [w]);
            var Mi = /ms/
        ...
        ms.exports = function() {
              ...
              , C = e.each = e.forEach = function(T, q, M) {
                ...
                if (p && T.forEach === p)
                    ...
                    for (var G = 0, K = T.length; G < K; G++)
                        if (q.call(M, T[G], G, T) === t)
                            return
                } else
                    for (var Z = e.keys(T), G = 0, K = Z.length; G < K; G++)
                        if (q.call(M, T[Z[G]], Z[G], T) === t)
                            return;
                return T
            }
            ;
            ...
            return e.template = function(T, q, M) {
                ...
                T.replace(G, function(X, F, Y, ae, oe) {
                    return Z += T.slice(K, oe).replace(re, $),
                    K = oe + X.length,
                    F ? Z += `'+
...
` + Z + "}",
    ...
    var tt = u((PB,Ps)=>{
        ...
        ;
        function As(e) {
            ce.env() && (et(e.design) && je.on("__wf_design", e.design),
    ...
    var xs = u((qB,Ls)=>{
        ...
        qs.define("brand", Ls.exports = function(e) {
            var t = {}, r = document, n = e("html"), a = e("body"), i = ".w-webflow-badge", o = window.location, s = /PhantomJS/i.test(navigator.userAgent), c = "fullscreenchange webkitfullscreenchange mozfullscreenchange msfullscreenchange", f;
            t.ready = function() {
    ...
    var Ds = u((LB,Ms)=>{
        ...
        Vi.define("edit", Ms.exports = function(e, t, r) {
            ...
            var n = {}, a = e(window), i = e(document.documentElement), o = document.location, s = "hashchange", c, f = r.load || v, p = !1;
            try {
            ...
            function R(P) {
                ...
                var C = function(D) {
                    D.data === "WF_third_party_cookies_unsupported" ? (m(w, C),
                    P(!1)) : D.data === "WF_third_party_cookies_supported" && (m(w, C),
                    P(!0))
                };
                w.onerror = function() {
                    m(w, C),
    ...
    var Gs = u((xB,Fs)=>{
        ...
        SI.define("focus-visible", Fs.exports = function() {
            function e(r) {
                ...
                function g(m) {
                    s(m.target) && m.target.hasAttribute("data-wf-focus-visible") && (a = !0,
                ...
                function _() {
                    document.visibilityState === "hidden" && (a && (n = !0),
                    N())
                }
                function N() {
    ...
    var Vs = u((MB,Us)=>{
        ...
        Xs.define("focus", Us.exports = function() {
            ...
            function i() {
                typeof document < "u" && document.body.hasAttribute("data-wf-focus-within") && Xs.env.safari && (document.addEventListener("mousedown", a, !0),
        ...
        var Bi = window.jQuery
          ...
          , un = {
            ...
            intro: function(e, t) {
                ...
                Bi(t).triggerHandler(rt.types.INTRO))
            },
            outro: function(e, t) {
                t.__wf_intro && (t.__wf_intro = null,
                Bi(t).triggerHandler(rt.types.OUTRO))
            }
        };
        rt.triggers = {};
        rt.types = {
    ...
    var Yi = u(($B,pu)=>{
        ...
        pu.exports = function(e) {
            if (e == null)
                throw VI("Can't call method on " + e);
            return e
        }
    }
    );
    ...
    var wu = u((nW,Ru)=>{
        var Au = ve(), Qi = Tu(), mu = Au.process, Ou = Au.Deno, Su = mu && mu.versions || Ou && Ou.version, bu = Su && Su.v8, Ke, dn;
        bu && (Ke = bu.split("."),
        dn = Ke[0] > 0 && Ke[0] < 4 ? 1 : +(Ke[0] + Ke[1]));
        !dn && Qi && (Ke = Qi.match(/Edge\/(\d+)/),
        (!Ke || Ke[1] >= 74) && (Ke = Qi.match(/Chrome\/(\d+)/),
        Ke && (dn = +Ke[1])));
        Ru.exports = dn
    }
    );
    ...
    var Uu = u((lW,Xu)=>{
        ...
        Xu.exports = function(e, t) {
            var r, n;
            if (t === "string" && ra(r = e.toString) && !na(n = ta(r, e)) || ra(r = e.valueOf) && !na(n = ta(r, e)) || t !== "string" && ra(r = e.toString) && !na(n = ta(r, e)))
                return n;
    ...
    var Rr = u(_c=>{
        ...
        _c.f = nm ? gc : function(t, r, n) {
            ...
            if ("get"in n || "set"in n)
                throw om("Accessors not supported");
    ...
    var qc = u((PW,Pc)=>{
        var _m = Oc(), Nc = ve(), Ea = ke(), ym = Wt(), Im = En(), ha = gt(), ga = vn(), Tm = va(), mm = hn(), Rc = "Object already initialized", ya = Nc.TypeError, Om = Nc.WeakMap, gn, wr, _n, Sm = function(e) {
        ...
        _m || ga.state ? (_t = ga.state || (ga.state = new Om),
        wc = Ea(_t.get),
        _a = Ea(_t.has),
        Cc = Ea(_t.set),
        gn = function(e, t) {
    ...
    var Uc = u((LW,Xc)=>{
        ...
        (Xc.exports = function(e, t, r, n) {
            var a = n ? !!n.unsafe : !1, i = n ? !!n.enumerable : !1, o = n ? !!n.noTargetGet : !1, s = n && n.name !== void 0 ? n.name : t, c;
    ...
    var ba = u((XW,Qc)=>{
        ...
        Qc.exports = function(e, t) {
            var r = $m(e), n = 0, a = [], i;
            for (i in r)
                !Sa(Zm, i) && Sa(r, i) && $c(a, i);
            for (; t.length > n; )
                Sa(r, i = t[n++]) && (~Qm(a, i) || $c(a, i));
            return a
        }
    }
    );
    ...
    var ll = u((kW,cl)=>{
        ...
        cl.exports = function(e, t) {
            var r = e.target, n = e.global, a = e.stat, i, o, s, c, f, p;
            if (n ? o = Aa : a ? o = Aa[r] || mO(r, {}) : o = (Aa[r] || {}).prototype,
            o)
                for (s in t) {
                    if (f = t[s],
                    e.noTargetGet ? (p = yO(o, s),
                    c = p && p.value) : c = o[s],
    ...
    var Sl = u(($W,Ol)=>{
        var LO = Ar(), xO = vl(), gl = yn(), MO = hn(), DO = hl(), FO = ca(), GO = va(), _l = ">", yl = "<", wa = "prototype", Ca = "script", Tl = GO("IE_PROTO"), Ra = function() {}, ml = function(e) {
    ...
    var Xa = u(Pr=>{
        ...
        function af(e, t, r) {
            ...
            function v(_) {
                ...
                for (var N = o = s, A = 0; A < N.length; A++)
                    N[A]();
                return _
            }
            function E(_) {
    ...
    var vf = u(On=>{
        ...
        var Eb = za()
          , {TRANSFORM_MOVE: hb, TRANSFORM_SCALE: gb, TRANSFORM_ROTATE: _b, TRANSFORM_SKEW: yb, STYLE_SIZE: Ib, STYLE_FILTER: Tb, STYLE_FONT_VARIATION: mb} = Eb.ActionTypeConsts
          , Ob = {
            [hb]: !0,
            [gb]: !0,
            [_b]: !0,
    ...
    var $t = u(he=>{
        ...
        function Rf(e, t, r) {
            if (e[t] === r)
                return e;
            for (var n = e.length, a = Array(n), i = 0; i < n; i++)
                a[i] = e[i];
            return a[t] = r,
            a
        }
        function wn(e, t) {
            if (!Array.isArray(t) && If(yf),
            e != null) {
        ...
        function Lf(e, t, r, n, a, i, o) {
            ...
            for (var c = void 0, f = arguments.length, p = Array(f > 7 ? f - 7 : 0), d = 7; d < f; d++)
                p[d - 7] = arguments[d];
            return p.length ? c = Fe.call.apply(Fe, [null, !1, !1, s, r, n, a, i, o].concat(p)) : c = Fe(!1, !1, s, r, n, a, i, o),
            Nn(e, t, c)
        }
        function xf(e, t) {
    ...
    var Ff = u(Pn=>{
        ...
        var t0 = e0(Yt())
          , r0 = De()
          , n0 = $t()
          , {IX2_PREVIEW_REQUESTED: i0, IX2_PLAYBACK_REQUESTED: a0, IX2_STOP_REQUESTED: o0, IX2_CLEAR_REQUESTED: s0} = r0.IX2EngineActionTypes
          , u0 = {
            preview: {},
            playback: {},
            stop: {},
    ...
    var Xf = u(qn=>{
        ...
        var l0 = De()
          , it = $t()
          , {IX2_SESSION_INITIALIZED: f0, IX2_SESSION_STARTED: d0, IX2_TEST_FRAME_RENDERED: p0, IX2_SESSION_STOPPED: v0, IX2_EVENT_LISTENER_ADDED: E0, IX2_EVENT_STATE_CHANGED: h0, IX2_ANIMATION_FRAME_CHANGED: g0, IX2_ACTION_LIST_PLAYBACK_CHANGED: _0, IX2_VIEWPORT_WIDTH_CHANGED: y0, IX2_MEDIA_QUERIES_DEFINED: I0} = l0.IX2EngineActionTypes
          , Gf = {
            active: !1,
            tick: 0,
            eventListeners: [],
          ...
          , m0 = (e=Gf,t)=>{
            ...
            case p0:
                {
                    let {payload: {step: r=T0}} = t;
                    return (0,
                    it.set)(e, "tick", e.tick + r)
                }
            case v0:
                return Gf;
            case g0:
            ...
            case E0:
                {
                    let r = (0,
                    it.addLast)(e.eventListeners, t.payload);
                    return (0,
                    it.set)(e, "eventListeners", r)
                }
            case h0:
                {
                    let {stateKey: r, newState: n} = t.payload;
                    return (0,
                    it.setIn)(e, ["eventState", r], n)
                }
            case _0:
                {
                    let {actionListId: r, isPlaying: n} = t.payload;
                    return (0,
                    it.setIn)(e, ["playbackState", r], n)
                }
            case y0:
                {
            ...
            case I0:
                return (0,
                it.set)(e, "hasDefinedMediaQueries", !0);
            default:
                return e
            }
        }
    ...
    var Hf = u((Uj,jf)=>{
        ...
        function N0(e) {
            ...
            if (r < 0)
                return !1;
            var n = t.length - 1;
            return r == n ? t.pop() : C0.call(t, r, 1),
            --this.size,
            !0
        }
        jf.exports = N0
        ...
        function Dw(e, t, r, n, a, i) {
            ...
            i.set(t, e); ++d < s; ) {
                var g = e[d]
                  , _ = t[d];
                if (n)
                    var N = o ? n(_, g, d, t, e, i) : n(g, _, d, e, t, i);
                if (N !== void 0) {
                    if (N)
                        continue;
                    v = !1;
    ...
    var Xn = u((V5,Vp)=>{
        ...
        function xC(e, t) {
            var r = typeof e;
            return t = t ?? qC,
            !!t && (r == "number" || r != "symbol" && LC.test(e)) && e > -1 && e % 1 == 0 && e < t
        }
        Vp.exports = xC
    }
    );
    ...
    var fo = u((k5,Zp)=>{
        ...
        function AN(e, t) {
            var r = IN(e)
              ...
              , c = s.length;
            for (var f in e)
                (t || bN.call(e, f)) && !(o && (f == "length" || a && (f == "offset" || f == "parent") || i && (f == "buffer" || f == "byteLength" || f == "byteOffset") || mN(f, c))) && s.push(f);
            return s
        }
        Zp.exports = AN
    }
        ...
        function $N(e, t, r, n, a, i) {
            ...
            for (var N = o; ++d < c; ) {
                ...
                var A = e[v]
                  , R = t[v];
                if (n)
                    var m = o ? n(R, A, v, t, e, i) : n(A, R, v, e, t, i);
        ...
        function RP(e, t, r, n) {
            ...
            for (; ++a < i; ) {
                ...
                if (o && s[2]) {
                    ...
                    if (n)
                        var v = n(f, p, c, e, t, d);
                    if (!(v === void 0 ? SP(p, f, bP | AP, n, d) : v))
                        return !1
                }
            }
            return !0
    ...
    var Kv = u((vH,kv)=>{
        ...
        function Oo(e, t) {
            ...
            var r = function() {
                ...
                return r.cache = i.set(a, o) || i,
                o
            };
            return r.cache = new (Oo.Cache || Hv),
            r
        }
        Oo.Cache = Hv;
        kv.exports = Oo
    ...
    var vE = u((bH,pE)=>{
        ...
        function wq(e, t, r) {
            ...
            return i || ++n != a ? i : (a = e == null ? 0 : e.length,
    ...
    var Zn = u(qe=>{
        ...
        qe.withBrowser = Qn;
        var ML = Qn(()=>(0,
        xL.default)(["matches", "matchesSelector", "mozMatchesSelector", "msMatchesSelector", "oMatchesSelector", "webkitMatchesSelector"], e=>e in Element.prototype));
        ...
        YE.exports = function(t, r, n, a) {
            ...
            if (t !== r || n !== a)
                for (var o = 0; o < Wr; ++o)
                    i[o] = ei(o * Jn, t, n);
            function s(c) {
                for (var f = 0, p = 1, d = Wr - 1; p !== d && i[p] <= c; ++p)
                    f += Jn;
                --p;
    ...
    var eh = u(ar=>{
        ...
        var ri = $t()
          , ZE = De()
          , {HTML_ELEMENT: kH, PLAIN_OBJECT: xx, ABSTRACT_NODE: KH, CONFIG_X_VALUE: Mx, CONFIG_Y_VALUE: Dx, CONFIG_Z_VALUE: Fx, CONFIG_VALUE: Gx, CONFIG_X_UNIT: Xx, CONFIG_Y_UNIT: Ux, CONFIG_Z_UNIT: Vx, CONFIG_UNIT: Bx} = ZE.IX2EngineConstants
          , {IX2_SESSION_STOPPED: Wx, IX2_INSTANCE_ADDED: jx, IX2_ELEMENT_STATE_CHANGED: Hx} = ZE.IX2EngineActionTypes
          , QE = {}
          , kx = "refState"
          , Kx = (e=QE,t={})=>{
            switch (t.type) {
            ...
            case jx:
                {
                    let {elementId: r, element: n, origin: a, actionItem: i, refType: o} = t.payload
                      , {actionTypeId: s} = i
                      , c = e;
                    return (0,
                    ri.getIn)(c, [r, n]) !== n && (c = JE(c, n, o, r, i)),
                    xo(c, r, s, a, i)
                }
            case Hx:
                {
                    let {elementId: r, actionTypeId: n, current: a, actionItem: i} = t.payload;
                    return xo(e, r, n, a, i)
                }
            default:
                return e
        ...
        function JE(e, t, r, n, a) {
            let i = r === xx ? (0,
            ri.getIn)(a, ["config", "target", "objectId"]) : null;
            return (0,
            ri.mergeIn)(e, [n], {
                id: n,
                ref: t,
        ...
        var zx = [[Mx, Xx], [Dx, Ux], [Fx, Vx], [Gx, Bx]];
        function Yx(e) {
            let {config: t} = e;
        ...
        var rh = Object.freeze({
          ...
          , uM = (e,t)=>{
            ...
            if (e) {
                let i = Object.keys(e)
                  , o = aM(n, i);
                return o.length ? o.reduce((c,f)=>(c[f] = rh[f],
                c), e) : e
            }
            return n.reduce((i,o)=>(i[o] = rh[o],
            i), {})
        }
        ;
    ...
    var ah = u(Oe=>{
        ...
        function ih(e) {
            let t, r, n, a = 1, i = e.replace(/\s/g, "").toLowerCase();
            if (i.startsWith("#")) {
                let o = i.substring(1);
                o.length === 3 ? (t = parseInt(o[0] + o[0], 16),
                r = parseInt(o[1] + o[1], 16),
                n = parseInt(o[2] + o[2], 16)) : o.length === 6 && (t = parseInt(o.substring(0, 2), 16),
                ...
                a = parseFloat(o[3]);
                let p = (1 - Math.abs(2 * f - 1)) * c, d = p * (1 - Math.abs(s / 60 % 2 - 1)), v = f - p / 2, E, g, _;
                s >= 0 && s < 60 ? (E = p,
                g = d,
                _ = 0) : s >= 60 && s < 120 ? (E = d,
                g = p,
                ...
                let o = i.match(/hsl\(([^)]+)\)/)[1].split(","), s = parseFloat(o[0]), c = parseFloat(o[1].replace("%", "")) / 100, f = parseFloat(o[2].replace("%", "")) / 100, p = (1 - Math.abs(2 * f - 1)) * c, d = p * (1 - Math.abs(s / 60 % 2 - 1)), v = f - p / 2, E, g, _;
                s >= 0 && s < 60 ? (E = p,
                g = d,
                _ = 0) : s >= 60 && s < 120 ? (E = d,
                g = p,
        ...
        var _M = (e,t,r)=>{
            let n = r.config.target.objectId, a = r.config.value.unit, {PLUGIN_VARIABLE: i} = t, {size: o, red: s, green: c, blue: f, alpha: p} = i, d;
            o != null && (d = o + a),
    ...
    var oh = u(ni=>{
        ...
        var Mo = IM(Yt())
          ...
          , mM = Fo(nh())
          , OM = Fo(ah())
          , SM = new Map([[Do.ActionTypeConsts.PLUGIN_LOTTIE, (0,
        Mo.default)({}, TM)], [Do.ActionTypeConsts.PLUGIN_SPLINE, (0,
        Mo.default)({}, mM)], [Do.ActionTypeConsts.PLUGIN_VARIABLE, (0,
        Mo.default)({}, OM)]]);
    ...
    var bh = u((ck,Sh)=>{
        ...
        function aD(e, t, r) {
            ...
            if (!n)
                return -1;
            var a = n - 1;
            return r !== void 0 && (a = rD(r),
            a = r < 0 ? nD(n + a, 0) : iD(a, n - 1)),
            eD(e, tD(t, 3), a, !0)
        }
        Sh.exports = aD
    }
    ...
    var Ch = u(ii=>{
        ...
        function lD(e, t) {
            ...
            for (let a = 0; a < r.length; a++)
                if (!cD.call(t, r[a]) || !wh(e[r[a]], t[r[a]]))
                    return !1;
            return !0
        }
        var fD = lD;
    ...
    var zh = u(le=>{
        ...
        var mt = ui(ch())
          ...
          , ut = Go()
          , Le = Zn()
          , {BACKGROUND: pD, TRANSFORM: vD, TRANSLATE_3D: ED, SCALE_3D: hD, ROTATE_X: gD, ROTATE_Y: _D, ROTATE_Z: yD, SKEW: ID, PRESERVE_3D: TD, FLEX: mD, OPACITY: oi, FILTER: Hr, FONT_VARIATION_SETTINGS: kr, WIDTH: ot, HEIGHT: st, BACKGROUND_COLOR: Gh, BORDER_COLOR: OD, COLOR: SD, CHILDREN: Ph, IMMEDIATE_CHILDREN: bD, SIBLINGS: qh, PARENT: AD, DISPLAY: si, WILL_CHANGE: or, AUTO: Ot, COMMA_DELIMITER: Kr, COLON_DELIMITER: RD, BAR_DELIMITER: Vo, RENDER_TRANSFORM: Xh, RENDER_GENERAL: jo, RENDER_STYLE: Ho, RENDER_PLUGIN: Uh} = xt.IX2EngineConstants
          , {TRANSFORM_MOVE: sr, TRANSFORM_SCALE: ur, TRANSFORM_ROTATE: cr, TRANSFORM_SKEW: zr, STYLE_OPACITY: Vh, STYLE_FILTER: Yr, STYLE_FONT_VARIATION: $r, STYLE_SIZE: lr, STYLE_BACKGROUND_COLOR: fr, STYLE_BORDER: dr, STYLE_TEXT_COLOR: pr, GENERAL_DISPLAY: ci, OBJECT_VALUE: wD} = xt.ActionTypeConsts
          , Bh = e=>e.trim()
          , ko = Object.freeze({
            [fr]: Gh,
            [dr]: OD,
        ...
        function Lh(e) {
            ...
            if (e != null && t === "object") {
                let {id: r, objectId: n, selector: a, selectorGuids: i, appliesTo: o, useEventTarget: s} = e;
                return {
                    id: r,
                    objectId: n,
                    selector: a,
        ...
        function Ko({config: e, event: t, eventTarget: r, elementRoot: n, elementApi: a}) {
            var i, o, s;
            if (!a)
                throw new Error("IX2 missing elementApi");
            let {targets: c} = e;
            if (Array.isArray(c) && c.length > 0)
                return c.reduce((M,G)=>M.concat(Ko({
                    config: {
                        target: G
                    },
                    event: t,
            ...
            let {getValidDocument: f, getQuerySelector: p, queryDocument: d, getChildElements: v, getSiblingElements: E, matchSelector: g, elementContains: _, isSiblingNode: N} = a
              , {target: A} = e;
            if (!A)
                return [];
            let {id: R, objectId: m, selector: P, selectorGuids: w, appliesTo: C, useEventTarget: D} = Lh(A);
            if (m)
                return [ai.has(m) ? ai.get(m) : ai.set(m, {}).get(m)];
            if (C === xt.EventAppliesTo.PAGE) {
                let M = f(R);
                return M ? [M] : []
            }
            let H = ((i = t == null || (o = t.action) === null || o === void 0 || (s = o.config) === null || s === void 0 ? void 0 : s.affectedElements) !== null && i !== void 0 ? i : {})[R || P] || {}, re = !!(H.id || H.selector), $, x, T, q = t && p(Lh(t.target));
            if (re ? ($ = H.limitAffectedElements,
            x = q,
            T = p(H)) : x = T = p({
                id: R,
                selector: P,
            ...
            t && D) {
                ...
                if (T) {
                    if (D === AD)
                        return d(T).filter(G=>M.some(K=>_(G, K)));
                    if (D === Ph)
                        return d(T).filter(G=>M.some(K=>_(K, G)));
                    if (D === qh)
                        return d(T).filter(G=>M.some(K=>N(K, G)))
                }
                return M
            }
        ...
        var xh = /px/
          , GD = (e,t)=>t.reduce((r,n)=>(r[n.type] == null && (r[n.type] = KD[n.type]),
        r), e || {})
          , XD = (e,t)=>t.reduce((r,n)=>(r[n.type] == null && (r[n.type] = zD[n.type] || n.defaultValue || 0),
        r), e || {});
        ...
        var VD = (e,t)=>(t && (e[t.type] = t.value || 0),
        e)
        ...
        e)
          , WD = (e,t,r)=>{
            ...
            ut.isPluginType)(e))
                return (0,
                ut.getPluginConfig)(e)(r, t);
            switch (e) {
            case Yr:
                {
                    let n = (0,
                    Bo.default)(r.filters, ({type: a})=>a === t);
                    return n ? n.value : 0
                }
            case $r:
                {
                    let n = (0,
                    Bo.default)(r.fontVariations, ({type: a})=>a === t);
                    return n ? n.value : 0
                }
            default:
                return r[t]
        ...
        function jD({element: e, actionItem: t, elementApi: r}) {
            if ((0,
            ut.isPluginType)(t.actionTypeId))
                return (0,
                ut.getPluginDestination)(t.actionTypeId)(t.config);
        ...
        var zo = {
          ...
          , YD = (e,t)=>{
            let r = (0,
            Bo.default)(t.filters, ({type: n})=>n === e);
            if (r && r.unit)
                return r.unit;
            switch (e) {
            case "blur":
        ...
        function QD(e, t, r, n, a) {
            let i = $D.map(s=>{
                let c = zo[s]
                  , {xValue: f=c.xValue, yValue: p=c.yValue, zValue: d=c.zValue, xUnit: v="", yUnit: E="", zUnit: g=""} = t[s] || {};
                switch (s) {
                case sr:
        ...
        function ZD(e, t, r, n) {
            let a = (0,
            Wo.default)(t, (o,s,c)=>`${o} ${c}(${s}${YD(c, r)})`, "")
              , {setStyle: i} = n;
            Mt(e, Hr, n),
            i(e, Hr, a)
        }
        ...
        function a1({element: e, actionTypeId: t, computedStyle: r, getStyle: n}) {
            ...
            return {
                rValue: (0,
                mt.default)(parseInt(s[0], 10), 255),
                gValue: (0,
                mt.default)(parseInt(s[1], 10), 255),
                bValue: (0,
                mt.default)(parseInt(s[2], 10), 255),
                aValue: (0,
                mt.default)(parseFloat(s[3]), 1)
            }
        }
            ...
            case ci:
                {
                    ...
                    a === mD && Le.IS_BROWSER_ENV ? n(e, si, Le.FLEX_PREFIXED) : n(e, si, a);
                    return
                }
            }
        }
        ...
        function Dh({actionGroup: e, event: t, elementApi: r}) {
            ...
            n.forEach(a=>{
                ...
                (0,
                ut.isPluginType)(i) ? s = c=>(0,
                ut.clearPlugin)(i)(c, a) : s = kh({
                    effect: l1,
                    actionTypeId: i,
                    elementApi: r
                }),
        ...
        function c1(e, t, r) {
            ...
            if (i === lr) {
                let {config: o} = t;
                o.widthUnit === Ot && n(e, ot, ""),
                o.heightUnit === Ot && n(e, st, "")
            }
            a(e, or) && kh({
                effect: Hh,
                actionTypeId: i,
        ...
        var kh = ({effect: e, actionTypeId: t, elementApi: r})=>n=>{
            switch (t) {
            case sr:
            case ur:
            case cr:
    ...
    var Zh = u(fi=>{
        ...
        var Yh = De()
          , $h = Dt()
          , Er = $t()
          , {IX2_RAW_DATA_IMPORTED: S1, IX2_SESSION_STOPPED: b1, IX2_INSTANCE_ADDED: A1, IX2_INSTANCE_STARTED: R1, IX2_INSTANCE_REMOVED: w1, IX2_ANIMATION_FRAME_CHANGED: C1} = Yh.IX2EngineActionTypes
          , {optimizeFloat: li, applyEasing: Qh, createBezierEasing: N1} = $h.IX2EasingUtils
          , {RENDER_GENERAL: P1} = Yh.IX2EngineConstants
          , {getItemConfigByKey: Yo, getRenderType: q1, getStyleProp: L1} = $h.IX2VanillaUtils
          , x1 = (e,t)=>{
            let {position: r, parameterId: n, actionGroups: a, destinationKeys: i, smoothing: o, restingValue: s, actionTypeId: c, customEasingFn: f, skipMotion: p, skipToValue: d} = e
          ...
          , M1 = (e,t)=>{
            let {active: r, origin: n, start: a, immediate: i, renderType: o, verbose: s, actionItem: c, destination: f, destinationKeys: p, pluginDuration: d, instanceDelay: v, customEasingFn: E, skipMotion: g} = e
              , _ = c.config.easing
            ...
            if (r && n) {
                ...
                if (s) {
                    ...
                    e = (0,
                    Er.set)(e, "verboseTimeElapsed", H * re)
                }
                if (m < 0)
                    return e;
          ...
          , D1 = (e=Object.freeze({}),t)=>{
            ...
            case A1:
                {
                    let {instanceId: r, elementId: n, actionItem: a, eventId: i, eventTarget: o, eventStateKey: s, actionListId: c, groupIndex: f, isCarrier: p, origin: d, destination: v, immediate: E, verbose: g, continuous: _, parameterId: N, actionGroups: A, smoothing: R, restingValue: m, pluginInstance: P, pluginDuration: w, instanceDelay: C, skipMotion: D, skipToValue: j} = t.payload
                      , {actionTypeId: H} = a
                      , re = q1(H)
                      , $ = L1(re, H)
    ...
    var Jh = u(di=>{
        ...
        var F1 = De()
          , {IX2_RAW_DATA_IMPORTED: G1, IX2_SESSION_STOPPED: X1, IX2_PARAMETER_CHANGED: U1} = F1.IX2EngineActionTypes
          , V1 = (e={},t)=>{
            switch (t.type) {
            case G1:
    ...
    var hg = u((Tk,Eg)=>{
        ...
        function b2(e) {
            for (var t = ug.lastIndex = 0; ug.test(e); )
                ++t;
            return t
        }
        Eg.exports = b2
    ...
    var zg = u((Fk,Kg)=>{
        ...
        function HF(e) {
            if (e == null)
                return !0;
            if (FF(e) && (DF(e) || typeof e == "string" || typeof e.splice == "function" || GF(e) || UF(e) || MF(e)))
                return !e.length;
            var t = xF(e);
            if (t == VF || t == BF)
                return !e.size;
    ...
    var s_ = u((Wk,o_)=>{
        var oG = at()
          ...
          , cG = Math.min;
        function lG(e, t, r) {
            var n, a, i, o, s, c, f = 0, p = !1, d = !1, v = !0;
            if (typeof e != "function")
    ...
    var c_ = u((jk,u_)=>{
        ...
        function vG(e, t, r) {
            ...
            return dG(r) && (n = "leading"in r ? !!r.leading : n,
    ...
    var vi = u(te=>{
        ...
        var l_ = EG(Yt())
          , f_ = De()
          , hG = Dt()
          , {IX2_RAW_DATA_IMPORTED: gG, IX2_SESSION_INITIALIZED: _G, IX2_SESSION_STARTED: yG, IX2_SESSION_STOPPED: IG, IX2_PREVIEW_REQUESTED: TG, IX2_PLAYBACK_REQUESTED: mG, IX2_STOP_REQUESTED: OG, IX2_CLEAR_REQUESTED: SG, IX2_EVENT_LISTENER_ADDED: bG, IX2_TEST_FRAME_RENDERED: AG, IX2_EVENT_STATE_CHANGED: RG, IX2_ANIMATION_FRAME_CHANGED: wG, IX2_PARAMETER_CHANGED: CG, IX2_INSTANCE_ADDED: NG, IX2_INSTANCE_STARTED: PG, IX2_INSTANCE_REMOVED: qG, IX2_ELEMENT_STATE_CHANGED: LG, IX2_ACTION_LIST_PLAYBACK_CHANGED: xG, IX2_VIEWPORT_WIDTH_CHANGED: MG, IX2_MEDIA_QUERIES_DEFINED: DG} = f_.IX2EngineActionTypes
        ...
        var WG = ({actionTypeId: e=f_.ActionTypeConsts.GENERAL_START_ACTION, actionListId: t, actionItemId: r, eventId: n, allowEvents: a, immediate: i, testManual: o, verbose: s, rawData: c})=>({
            type: mG,
            payload: {
                actionTypeId: e,
                actionListId: t,
    ...
    var v_ = u(Ce=>{
        ...
        var iX = Dt()
          ...
          , {IX2_ID_DELIMITER: d_, HTML_ELEMENT: oX, PLAIN_OBJECT: sX, WF_PAGE: p_} = aX.IX2EngineConstants;
        function uX(e, t, r) {
            e.style[t] = r
        }
        function cX(e, t) {
            ...
            if (e) {
                ...
                if (e.indexOf(d_) !== -1) {
                    let n = e.split(d_)
                      , a = n[0];
                    if (r = n[1],
                    a !== document.documentElement.getAttribute(p_))
                        return null
                }
    ...
    var q_ = u((eK,P_)=>{
        ...
        function MX(e, t, r) {
            ...
            function() {
                for (var n = arguments, a = -1, i = N_(n.length - t, 0), o = Array(i); ++a < i; )
                    o[a] = n[t + a];
                a = -1;
    ...
    var ay = u((pK,iy)=>{
        ...
        function dU(e) {
            ...
            return t.__actions__ = fU(e.__actions__),
    ...
    var ly = u((EK,cy)=>{
        ...
        function SU(e) {
            var t = mU(e)
              , r = OU[t];
            if (typeof r != "function" || !(t in IU.prototype))
                return !1;
            if (e === r)
                return !0;
            var n = TU(r);
    ...
    var Gy = u(bi=>{
        ...
        var Ue = Si(Yt())
          ...
          , Ti = vi()
          , BU = Dt()
          , {MOUSE_CLICK: WU, MOUSE_SECOND_CLICK: jU, MOUSE_DOWN: HU, MOUSE_UP: kU, MOUSE_OVER: KU, MOUSE_OUT: zU, DROPDOWN_CLOSE: YU, DROPDOWN_OPEN: $U, SLIDER_ACTIVE: QU, SLIDER_INACTIVE: ZU, TAB_ACTIVE: JU, TAB_INACTIVE: eV, NAVBAR_CLOSE: tV, NAVBAR_OPEN: rV, MOUSE_MOVE: nV, PAGE_SCROLL_DOWN: Cy, SCROLL_INTO_VIEW: Ny, SCROLL_OUT_OF_VIEW: iV, PAGE_SCROLL_UP: aV, SCROLLING_IN_VIEW: oV, PAGE_FINISH: Py, ECOMMERCE_CART_CLOSE: sV, ECOMMERCE_CART_OPEN: uV, PAGE_START: qy, PAGE_SCROLL: cV} = Ft.EventTypeConsts
          , us = "COMPONENT_ACTIVE"
        ...
        Ue.default)({}, en, {
          ...
          , Zr = (()=>{
            ...
            return ()=>({
                ...
                stiffScrollTop: (0,
                VU.default)(e ? window.pageYOffset : r.scrollTop, 0, r.scrollHeight - window.innerHeight),
        ...
        Ue.default)({}, ls, {
            handler: hV((e,t)=>{
                let {elementVisible: r} = t
                  ...
                  , {ixData: i} = a.getState()
                  , {events: o} = i;
                return !o[n.action.config.autoStopEventId] && t.triggered ? t : n.eventTypeId === Ny === r ? (Ge(e),
                (0,
                Ue.default)({}, t, {
                    triggered: !0
                })) : t
          ...
          , IV = {
            ...
            [WU]: {
                types: "click",
                handler: Ye(ct, Ay((e,{clickCount: t})=>{
                    fV(e) ? t === 1 && Ge(e) : Ge(e)
                }
                ))
            },
            ...
            [nV]: {
                ...
                handler: ({store: e, element: t, eventConfig: r, nativeEvent: n, eventStateKey: a},i={
                    clientX: 0,
                    clientY: 0,
                    pageX: 0,
                    pageY: 0
                    ...
                    let {basedOn: o, selectedAxis: s, continuousParameterGroupId: c, reverse: f, restingState: p=0} = r
                      , {clientX: d=i.clientX, clientY: v=i.clientY, pageX: E=i.pageX, pageY: g=i.pageY} = n
                      , _ = s === "X_AXIS"
                      , N = n.type === "mouseout"
                      , A = p / 100
                      , R = c
                    ...
                    case Ft.EventBasedOn.PAGE:
                        {
                            let {scrollLeft: P, scrollTop: w, scrollWidth: C, scrollHeight: D} = Zr();
                    ...
                    return N && (A > 1 - wy || A < wy) && (A = Math.round(A)),
                    (o !== Ft.EventBasedOn.ELEMENT || m || m !== i.elementHovered) && (A = f ? 1 - A : A,
                    e.dispatch((0,
                    Ti.parameterChanged)(R, A))),
                    {
                        elementHovered: m,
                        clientX: d,
                        clientY: v,
            ...
            [cV]: {
                ...
                handler: ({store: e, eventConfig: t})=>{
                    ...
                    s = n ? 1 - s : s,
                    e.dispatch((0,
                    Ti.parameterChanged)(r, s))
                }
            },
            [oV]: {
                types: cs,
                handler: ({element: e, store: t, eventConfig: r, eventStateKey: n},a={
                    scrollPercent: 0
                })=>{
                    let {scrollLeft: i, scrollTop: o, scrollWidth: s, scrollHeight: c, clientHeight: f} = Zr()
                      , {basedOn: p, selectedAxis: d, continuousParameterGroupId: v, startsEntering: E, startsExiting: g, addEndOffset: _, addStartOffset: N, addOffsetValue: A=0, endOffsetValue: R=0} = r
                      , m = d === "X_AXIS";
                    if (p === Ft.EventBasedOn.VIEWPORT) {
                        let P = m ? i / s : o / c;
                        return P !== a.scrollPercent && t.dispatch((0,
                        Ti.parameterChanged)(v, P)),
                        {
                            scrollPercent: P
                        }
                    } else {
                        ...
                        return T !== a.scrollPercent && t.dispatch((0,
                        Ti.parameterChanged)(P, T)),
                        {
                            scrollPercent: T
                        }
                    }
    ...
    var fs = u(bt=>{
        ...
        var mV = Qe(Yt())
          ...
          , ds = e=>qV.includes(e)
          , {COLON_DELIMITER: ps, BOUNDARY_SELECTOR: Ai, HTML_ELEMENT: By, RENDER_GENERAL: LV, W_MOD_IX: Xy} = $e.IX2EngineConstants
          , {getAffectedElements: Ri, getElementId: xV, getDestinationValues: vs, observeStore: Gt, getInstanceId: MV, renderHTMLElement: DV, clearAllStyles: Wy, getMaxDurationItemIndex: FV, getComputedStyle: GV, getInstanceOrigin: XV, reduceListToGroup: UV, shouldNamespaceEventParameter: VV, getNamespacedParameterId: BV, shouldAllowMediaQuery: wi, cleanupHTMLElement: WV, clearObjectCache: jV, stringifyTarget: HV, mediaQueriesEqual: kV, shallowEqual: KV} = Vy.IX2VanillaUtils
          , {isPluginType: Ci, createPluginInstance: Es, getPluginDuration: zV} = Vy.IX2VanillaPlugins
        ...
        function tB(e, t) {
            let {actionTypeId: r, actionListId: n, actionItemId: a, eventId: i, allowEvents: o, immediate: s, testManual: c, verbose: f=!0} = e
              , {rawData: p} = e;
            if (n && a && p && s) {
        ...
        function sB({store: e, eventStateKey: t, eventTarget: r, eventId: n, eventConfig: a, actionListId: i, parameterGroup: o, smoothing: s, restingValue: c}) {
        ...
        function uB(e=[], t, r) {
            let n = [...e], a;
            return n.some((i,o)=>i.keyframe === t ? (a = o,
            !0) : !1),
            a == null && (a = n.length,
            n.push({
                keyframe: t,
        ...
        function EB({logic: e, store: t, events: r}) {
            ...
            tn.default)(s, (d,v)=>{
                ...
                kV(N, i.mediaQueryKeys) || t.dispatch((0,
                ge.mediaQueriesDefined)()),
                g.actionTypeId === $e.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION && (Array.isArray(E.config) ? E.config : [E.config]).forEach(m=>{
                    let {continuousParameterGroupId: P} = m
                      , w = (0,
                    St.default)(o, `${A}.continuousParameterGroups`, [])
                      , C = (0,
                    SV.default)(w, ({id: H})=>H === P)
                      , D = (m.smoothing || 0) / 100
        ...
        function hB(e) {
            ...
            for (let n in e) {
                ...
                t[o] || (a === $e.EventTypeConsts.MOUSE_CLICK || a === $e.EventTypeConsts.MOUSE_SECOND_CLICK) && (t[o] = !0,
        ...
        function ky({store: e, actionListId: t, eventId: r}) {
            ...
            if (c && c.useFirstGroupAsInitialState) {
                let f = (0,
                St.default)(c, "actionItemGroups[0].actionItems", [])
                  , p = (0,
                St.default)(s, "mediaQueries", n.mediaQueryKeys);
                if (!wi(p, a.mediaQueryKey))
                    return;
                f.forEach(d=>{
                    var v;
                    let {config: E, actionTypeId: g} = d
                      , _ = (E == null || (v = E.target) === null || v === void 0 ? void 0 : v.useEventTarget) === !0 ? {
                        target: s.target,
                        targets: s.targets
                    } : E
                      , N = Ri({
        ...
        function hs({store: e, eventId: t, eventTarget: r, eventStateKey: n, actionListId: a}) {
            let {ixInstances: i, ixSession: o} = e.getState()
              , s = o.hasBoundaryNodes && r ? me.getClosestElement(r, Ai) : null;
            (0,
            tn.default)(i, c=>{
                let f = (0,
                St.default)(c, "actionItem.config.target.boundaryMode")
        ...
        function gs({store: e, eventId: t, eventTarget: r, eventStateKey: n, actionListId: a, groupIndex: i=0, immediate: o, verbose: s}) {
            var c;
            let {ixData: f, ixSession: p} = e.getState()
              , {events: d} = f
              , v = d[t] || {}
        ...
        function _s(e) {
            var t;
            let {store: r, computedStyle: n} = e, a = (0,
            OV.default)(e, PV), {element: i, actionItem: o, immediate: s, pluginInstance: c, continuous: f, restingValue: p, eventId: d} = a, v = !f, E = MV(), {ixElements: g, ixSession: _, ixData: N} = r.getState(), A = xV(g, i), {refState: R} = g[A] || {}, m = me.getRefType(i), P = _.reducedMotion && $e.ReducedMotionTypes[o.actionTypeId], w;
            if (P && f)
            ...
            Gt({
                store: r,
                select: ({ixInstances: D})=>D[E],
                onChange: Yy
            }),
            v && r.dispatch((0,
            ge.instanceStarted)(E, _.tick))
        }
        function ys(e, t) {
        ...
        function Yy(e, t) {
            let {active: r, continuous: n, complete: a, elementId: i, actionItem: o, actionTypeId: s, renderType: c, current: f, groupIndex: p, eventId: d, eventTarget: v, eventStateKey: E, actionListId: g, isCarrier: _, styleProp: N, verbose: A, pluginInstance: R} = e
            ...
            if (wi(D, P.mediaQueryKey) && (n || r || a)) {
                if (f || c === LV && a) {
                    t.dispatch((0,
                    ge.elementStateChanged)(i, s, f, o));
    ...
    var Qy = u(vt=>{
        ...
        vt.actions = mB;
        var qi = (0,
        IB.createStore)(TB.default);
        vt.store = qi;
        function OB(e) {
            e() && (0,
            Is.observeRequests)(qi)
        }
        function SB(e) {
            $y(),
            (0,
    ...
    var nI = u((SK,rI)=>{
        ...
        hr.define("links", rI.exports = function(e, t) {
            var r = {}, n = e(window), a, i = hr.env(), o = window.location, s = document.createElement("a"), c = "w--current", f = /index\.(html|php)$/, p = /\/$/, d, v;
            ...
            function E() {
                ...
                hr.scroll.off(_),
                d = [];
                for (var A = document.links, R = 0; R < A.length; ++R)
                    g(A[R]);
                d.length && (hr.scroll.on(_),
                _())
            }
            function g(A) {
                ...
                function v(N) {
                    if (o) {
                        ...
                        var A = N.touches
                          ...
                          , m = R - p;
                        p = R,
                        Math.abs(m) > c && r && String(r()) === "" && (a("swipe", N, {
    ...
    var lI = u((wK,cI)=>{
        ...
        xi.define("forms", cI.exports = function(e, t) {
            var r = {}, n = e(document), a, i = window.location, o = window.XDomainRequest && !window.atob, s = ".w-form", c, f = /e(-)?mail/i, p = /^\S+@\S+$/, d = window.alert, v = xi.env(), E, g, _, N = /list-manage[1-9]?.com/i, A = t.debounce(function() {
            ...
            function R() {
                ...
                o && g.indexOf("https://webflow.com") >= 0 && (g = g.replace("https://webflow.com", "https://formdata.webflow.com")),
                _ = `${g}/signFile`,
                a = e(s + " form"),
                a.length && a.each(m)
            }
            ...
            function G(L, V) {
                if (!V.fileUploads || !V.fileUploads[L])
                    return;
                var B, X = e(V.fileUploads[L]), F = X.find("> .w-file-upload-default"), Y = X.find("> .w-file-upload-uploading"), ae = X.find("> .w-file-upload-success"), oe = X.find("> .w-file-upload-error"), z = F.find(".w-file-upload-input"), pe = F.find(".w-file-upload-label"), Xt = pe.children(), _e = oe.find(".w-file-upload-error-msg"), Et = ae.find(".w-file-upload-file"), gr = ae.find(".w-file-remove-link"), _r = Et.find(".w-file-upload-file-name"), yr = _e.attr("data-w-size-error"), Ze = _e.attr("data-w-type-error"), Mi = _e.attr("data-w-generic-error");
                if (v || pe.on("click keydown", function(y) {
                    y.type === "keydown" && y.which !== 13 && y.which !== 32 || (y.preventDefault(),
                    z.click())
                }),
                ...
                function l(y) {
                    var S = y.responseJSON && y.responseJSON.msg
                      , W = Mi;
                    typeof S == "string" && S.indexOf("InvalidFileTypeError") === 0 ? W = Ze : typeof S == "string" && S.indexOf("MaxFileSizeError") === 0 && (W = yr),
                    _e.text(W),
                    z.removeAttr("data-value"),
                    z.val(""),
                    Y.toggle(!1),
...
Webflow.require('ix2').init({
    "events": {
        "e-3": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "652b53b37568770d043d1279|35679220-dfab-b8fb-fe20-1dd14c1bffbe"
            },
            "targets": [],
            "config": {
                "loop": false,
        ...
        "e-7": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "652b53b37568770d043d1279|97de87b6-10be-14f2-ed2b-4bcc027b0546"
            },
            "targets": [],
            "config": {
                "loop": false,
        ...
        "e-11": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "652b53b37568770d043d1279|7009466c-4715-bee5-2d7d-4af403e94082"
            },
            "targets": [],
            "config": {
                "loop": false,
    ...
    "actionLists": {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "value": "none",
                        "target": {
                            "id": "652b53b37568770d043d1279|01aeadad-7359-ea3f-c3bf-42f74bbf2324"
                        }
                    }
                }]
            }, {
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "value": "none",
                        "target": {
                            "id": "652b53b37568770d043d1279|a8083f58-9af9-e640-56b6-96c85580b8ff"
                        }
                    }
                }]
            }, {
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "value": "block",
                        "target": {
                            "id": "652b53b37568770d043d1279|4dbeeb02-be73-4e3c-6754-5e6b61176827"
                        }
                    }
                }]
            }, {
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "value": "none",
                        "target": {
                            "id": "652b53b37568770d043d1279|5aee1185-7f35-2046-0dcc-c34dec84c9c2"
                        }
                    }
                }]
            }, {
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "value": "block",
                        "target": {
                            "id": "652b53b37568770d043d1279|3c319a06-6d11-0fb0-0da0-448d025a6fb6"
                        }
                    }
                }]
            }, {
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "value": "none",
                        "target": {
                            "id": "652b53b37568770d043d1279|a8083f58-9af9-e640-56b6-96c85580b8ec"
                        }
                    }
                }]
            }, {
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "value": "none",
                        "target": {
                            "id": "652b53b37568770d043d1279|a8083f58-9af9-e640-56b6-96c85580b8f8"
                        }
                    }
                }]
            }, {
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "value": "flex",
                        "target": {
                            "id": "652b53b37568770d043d1279|a8083f58-9af9-e640-56b6-96c85580b8e5"
                        }
                    }
                }]
            }],
            "createdOn": 1697457216662,
            "useFirstGroupAsInitialState": false
        },
        "a-4": {
            "id": "a-4",
            "title": "Hide \"delete and next\" btn",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-4-n",
                    "actionTypeId": "GENERAL_DISPLAY",
        ...
        "a-2": {
            ...
            "actionItemGroups": [{
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "value": "block",
                        "target": {
                            "id": "652b53b37568770d043d1279|a8083f58-9af9-e640-56b6-96c85580b945"
                        }
                    }
                }]
            }, {
            ...
            "createdOn": 1697458134606,
            "useFirstGroupAsInitialState": false
        },
        "a-3": {
            "id": "a-3",
            "title": "hide project next action",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-3-n",
                    "actionTypeId": "GENERAL_DISPLAY",
            ...
            "createdOn": 1697458560974,
            "useFirstGroupAsInitialState": false
        },
        "a-5": {
            "id": "a-5",
            "title": "show \"Delete and next\" btn",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-5-n",
                    "actionTypeId": "GENERAL_DISPLAY",
